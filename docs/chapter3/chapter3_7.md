...
实验台仍然只保留图片框架最核心的决策，不冒充真实网络和完整框架实现。它负责把因果关系演清楚；最终结论还要到 [`demo/chapter03-image-pipeline`](https://github.com/android24/DroidStack/tree/main/demo/chapter03-image-pipeline) 中用 Coil、Glide 和 Android 设备验证。
